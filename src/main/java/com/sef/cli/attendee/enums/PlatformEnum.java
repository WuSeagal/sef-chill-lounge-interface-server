...
public enum PlatformEnum {
    ...
    FACEBOOK_PAGE(Pattern.compile("^(www\\.|m\\.)?facebook\\.com$|^fb\\.com$", Pattern.CASE_INSENSITIVE)),
    ...
    DISCORD_SERVER(Pattern.compile("^(www\\.)?discord\\.gg$", Pattern.CASE_INSENSITIVE)),
